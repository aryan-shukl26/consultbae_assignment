...
# exact duplicate check (e.g. "R. Verma" / "Rohit Verma" — same email+phone,
# two name spellings)
dupes = df1_final[
...
# alt-email case (e.g. Nikhil Chopra — same phone/city, two different emails):
# keep both rows, group them under one dedup_group_id rather than dropping either
...
# lowercase skills for consistent cross-file comparison against source2
...
##Exact Matches using Email and Ph
"""
...
# =============================================================================
# Cell 11 — insert skills (source1 Skills + source2 skill_tags)
# =============================================================================
...
# 2. Person count and confidence breakdown
...
# 3. No duplicate skill rows (person_id, skill, source) — the UNIQUE
# constraint should already prevent this, this just double-checks it held
verify_cur.execute("""
...
# 4. Spot check: the two confirmed same-name-different-person cases stayed
# separate (Arjun Mehta, Deepak Nair) rather than being wrongly merged
...
# 5. CTC stored as a real number, not corrupted (the numpy-cast bug check)
...
# 6. Every person_source_record points at a real person (no orphaned FK)
verify_cur.execute("""
